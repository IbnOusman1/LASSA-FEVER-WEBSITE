...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:CvNVBD6Zj/OCD5h+klZOpQ==$FiBIyErucMtiI1SXTJudDqXHa6zooN4kC7ITiU6E0fo=:y7CXVdWzC2QlTJHUV5NB0hBTE1kbT98P10M7yNDqs1Q=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:0Hn19k4Jd+aUa0y70xJ+Og==$qIYQNRgZWS78xC9mTR9/GrXt5efIwKd8F/B1MTDJHxU=:uBqYCyVf8o67E7vlOsAIPGYK5V6iu1afzczSa2zL8/w=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:C1iulIaOBWYKkrE3v6Nb+A==$5kr4rYM+2RDLvLzOaARoIUQcfXGDyHd4bIDimDgXrTo=:L36JXjQ2dD3U8vgVtkIdg+dzALtmwKRsofwBLQVH2ew=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:QssmK2R3B4c88JznL1Yv9g==$1sBj/4Tpzc+vejNsFI0vgn61x3jwqG4S2Ks3naG0D9I=:0mNWvEzH5XN0GjtfMZdF/LORsVJAvQJu4gbpb6AlGpY=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:NMdQtgRVcn3hYsEh9mTBaA==$FqNRTAVcGoeFsx/ja5tMnju9qKzlt+x5XYb9NA5mRts=:00GN1/vaJV/vLWbmlQK0sK7jSeAID+geDZ5cSpQi4/c=';
-- CREATE ROLE "supabase_etl_admin";
-- ALTER ROLE "supabase_etl_admin" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:rhnqMat3VmaWpOpczzLaQw==$GqYAk3QboYTWHCvg7o0E25THl0wK3HMf5qymuNSMpgQ=:zvfspyl2nNCkOZe2RN1FMVXlGcDNrY6YptQBzF3QwPk=';
-- CREATE ROLE "supabase_privileged_role";
-- ALTER ROLE "supabase_privileged_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOBYPASSRLS;
-- CREATE ROLE "supabase_read_only_user";
-- ALTER ROLE "supabase_read_only_user" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Lf8gPgC8PH6StU4HLJf8xQ==$/VbRKL7FwsXwXKqqJjk4MmW+twbLG6kSVc9Uf+UUU04=:094oBoBRzlTUVhWba2IQVGfEpESbc5B0XPd/G2kkP1k=';
-- CREATE ROLE "supabase_realtime_admin";
-- ALTER ROLE "supabase_realtime_admin" WITH NOINHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOBYPASSRLS;
-- CREATE ROLE "supabase_replication_admin";
-- ALTER ROLE "supabase_replication_admin" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN REPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:a2dUbK1N+t3xvOdcSEwRhw==$n1msssQPNGDZUGFQTyB4l41tKfVVr1qOshHg98ixKS8=:dZYRXTtN2/KwT3ydxET9/uoeuMOcGjQln2DU3jBhUL0=';
-- CREATE ROLE "supabase_storage_admin";
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:B5B91K76dxpQZ1ala0H8uA==$c5yEhzLK0+f/UXGazrMNV1fhZaFFquSupm+Tr+X2FYk=:uO4tc6nL49GwZjevHyzFE3v4gUjyTg4qeaK33vneYgo=';
...
--
-- Name: generate_reference_number(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: generate_report_reference(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."generate_report_reference"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
--
-- Name: outbreak_data; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."outbreak_data" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "state" "text" NOT NULL,
    ...
    "suspected" integer DEFAULT 0 NOT NULL,
    "notes" "text",
    "entered_by" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "chk_od_confirmed_max" CHECK (("confirmed" <= 99999)),
    CONSTRAINT "chk_od_confirmed_pos" CHECK (("confirmed" >= 0)),
    CONSTRAINT "chk_od_date_not_future" CHECK (("report_date" <= CURRENT_DATE)),
    CONSTRAINT "chk_od_deaths_lte_confirmed" CHECK (("deaths" <= "confirmed")),
    CONSTRAINT "chk_od_deaths_max" CHECK (("deaths" <= 99999)),
    CONSTRAINT "chk_od_deaths_pos" CHECK (("deaths" >= 0)),
    CONSTRAINT "chk_od_entered_by_len" CHECK ((("entered_by" IS NULL) OR ("char_length"("entered_by") <= 100))),
    CONSTRAINT "chk_od_notes_len" CHECK ((("notes" IS NULL) OR ("char_length"("notes") <= 500))),
    CONSTRAINT "chk_od_recoveries_max" CHECK (("recoveries" <= 99999)),
    CONSTRAINT "chk_od_recoveries_pos" CHECK (("recoveries" >= 0)),
    CONSTRAINT "chk_od_state_len" CHECK (("char_length"("state") <= 60)),
    CONSTRAINT "chk_od_suspected_max" CHECK (("suspected" <= 99999)),
    CONSTRAINT "chk_od_suspected_pos" CHECK (("suspected" >= 0))
);


--
-- Name: symptom_reports; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE "public"."symptom_reports" (
    ...
    CONSTRAINT "chk_sr_email_len" CHECK ((("email" IS NULL) OR ("char_length"("email") <= 120))),
    CONSTRAINT "chk_sr_lga_len" CHECK ((("lga" IS NULL) OR ("char_length"("lga") <= 80))),
    CONSTRAINT "chk_sr_name_len" CHECK (("char_length"("name") <= 100)),
    CONSTRAINT "chk_sr_name_not_empty" CHECK (("char_length"(TRIM(BOTH FROM "name")) > 0)),
    CONSTRAINT "chk_sr_onset_not_future" CHECK ((("onset_date" IS NULL) OR ("onset_date" <= CURRENT_DATE))),
    CONSTRAINT "chk_sr_phone_len" CHECK (("char_length"("phone") <= 20)),
    CONSTRAINT "chk_sr_phone_not_empty" CHECK (("char_length"(TRIM(BOTH FROM "phone")) > 0)),
    CONSTRAINT "chk_sr_state_len" CHECK (("char_length"("state") <= 60)),
    CONSTRAINT "chk_sr_symptom_len" CHECK (("char_length"("symptom_description") <= 1000))
);
...
--
-- Name: outbreak_data outbreak_data_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."outbreak_data"
    ADD CONSTRAINT "outbreak_data_pkey" PRIMARY KEY ("id");


--
-- Name: symptom_reports symptom_reports_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."symptom_reports"
    ADD CONSTRAINT "symptom_reports_pkey" PRIMARY KEY ("id");
...
--
-- Name: idx_outbreak_data_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_outbreak_data_date" ON "public"."outbreak_data" USING "btree" ("report_date" DESC);


--
-- Name: idx_outbreak_data_state; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_outbreak_data_state" ON "public"."outbreak_data" USING "btree" ("state");


--
-- Name: idx_outbreak_data_state_date; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "idx_outbreak_data_state_date" ON "public"."outbreak_data" USING "btree" ("state", "report_date");
...
--
-- Name: symptom_reports set_report_reference; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "set_report_reference" BEFORE INSERT ON "public"."symptom_reports" FOR EACH ROW EXECUTE FUNCTION "public"."generate_report_reference"();


--
-- Name: symptom_reports trg_generate_ref_number; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "trg_generate_ref_number" BEFORE INSERT ON "public"."symptom_reports" FOR EACH ROW EXECUTE FUNCTION "public"."generate_reference_number"();
...
--
-- Name: symptom_reports anyone_can_insert_reports; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "anyone_can_insert_reports" ON "public"."symptom_reports" FOR INSERT TO "authenticated", "anon" WITH CHECK (true);


--
-- Name: outbreak_data; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."outbreak_data" ENABLE ROW LEVEL SECURITY;

--
-- Name: outbreak_data outbreak_data_insert_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "outbreak_data_insert_all" ON "public"."outbreak_data" FOR INSERT TO "authenticated", "anon" WITH CHECK (true);


--
-- Name: outbreak_data outbreak_data_select_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "outbreak_data_select_all" ON "public"."outbreak_data" FOR SELECT TO "authenticated", "anon" USING (true);


--
-- Name: outbreak_data outbreak_data_update_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "outbreak_data_update_all" ON "public"."outbreak_data" FOR UPDATE TO "authenticated", "anon" USING (true);


--
-- Name: symptom_reports; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime outbreak_data; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."outbreak_data";


--
-- Name: supabase_realtime symptom_reports; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."symptom_reports";
